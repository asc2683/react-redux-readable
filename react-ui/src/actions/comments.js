...
export const fetchComments = (id) => thunkCreator({
  ...
  promise: fetch(`https://readable4.herokuapp.com/posts/${id}/comments`, { headers: { 'Authorization': 'whatever-you-want' } })
...
const _createComment = (comment) => thunkCreator({
  ...
  promise: fetch('https://readable4.herokuapp.com/comments', {
    method: 'POST',
    headers: {
...
const _deleteComment = (id) => (
  fetch(`https://readable4.herokuapp.com/comments/${id}`, {
    method: 'DELETE',
    headers: {
      'Authorization': 'whatever-you-want',
      'Accept': 'application/json',
...
const _updateComment = (comment) => (
  ...
  fetch(`https://readable4.herokuapp.com/comments/${comment.id}`, {
      method: 'PUT',
      headers: {
        'Authorization': 'whatever-you-want',
        'Accept': 'application/json',
  ...
  const _upVoteComment = (comment) => thunkCreator({
    ...
    promise: fetch(`https://readable4.herokuapp.com/comments/${comment.id}`, {
      method: 'POST',
      headers: {
        'Authorization': 'whatever-you-want',
        'Accept': 'application/json',
